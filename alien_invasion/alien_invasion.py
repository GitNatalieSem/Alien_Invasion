...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Fullscreen setting for regular gameplay
        ...
        for bullet in self.bullets:
            for alien in self.aliens:
                if alien.rect.colliderect(bullet.rect):
                    self.sounds.alien_hit_sound.stop()
    ...
    def _check_keydown_events(self, event):
        if event.key == pygame.K_RIGHT:
            ...
            if self.stats.game_active == True:
                self._fire_bullet()
                self.sounds.gunfire_sounds.stop()
                self.sounds.gunfire_sounds.play()
            else:
                self._start_game()

        elif event.key == pygame.K_t:
            pygame.mixer.Sound.play(self.sounds.bg_music)
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                ...
                self._ship_hit()
                self.sounds.alien_offscreen_sound.play()
                break
